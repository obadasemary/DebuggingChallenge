...
struct LoginScreen: View {
    ...
    @StateObject var sessionServiceWrapper = SessionServiceWrapper()
...
class SessionServiceWrapper: ObservableObject {
    let service: SessionService = DefaultSessionService()
}
